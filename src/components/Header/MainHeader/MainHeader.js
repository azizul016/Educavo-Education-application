  ...
  return (
    <>
      <div className='full-width-header home8-style4 main-home'>
        {/* cannot solved */}
        {/* <header id='rs-header' className={stickyNav ? 'sticky rs-header': 'rs-header'}> */}
                        ...
                        <ul className='nav-menu'>
                          ...
                          <li className='menu-item-has-children'>
                            ...
                            <ul className='sub-menu'>
                              ...
                              <li>
                                <a href='about2.html'>About Two</a>{" "}
                              </li>
                            </ul>
                          </li>
                          ...
                          <li className='menu-item-has-children'>
                            ...
                            <ul className='sub-menu'>
                              <li>
                                <a href='course.html'>Courses One</a>{" "}
                              </li>
                              <li>
                                <a href='course2.html'>Courses Two</a>{" "}
                              </li>
                              <li>
                                <a href='course3.html'>Courses Three</a>{" "}
                              </li>
                              <li>
                                <a href='course4.html'>Courses Four</a>
                              </li>
                              <li>
                                <a href='course5.html'>Courses Five</a>{" "}
                              </li>
                              <li>
                          ...
                          <li className='menu-item-has-children'>
                            ...
                            <ul className='sub-menu'>
                              ...
                              <li>
                                <a href='contact3.html'>Contact Three</a>{" "}
                              </li>
                              <li>
                                <a href='contact4.html'>Contact Four</a>{" "}
                              </li>
                            </ul>
                          </li>
                        </ul>
                        ...
                        <div className='woocommerce-mini-cart text-left'>
                          <div className='cart-bottom-part'>
                            <ul className='cart-icon-product-list'>
                              <li className='display-flex'>
                                ...
                                <div className='product-info'>
                                  <a href='cart.html'>Law Book</a>
                                  <br />
                                  <span className='quantity'>1 × $30.00</span>
                                </div>
                                <div className='product-image'>
                                  <a href='cart.html'>
                                    <img src={s1} alt='Product Image' />
                                  </a>
                                </div>
                              </li>
                              <li className='display-flex'>
                                ...
                                <div className='product-info'>
                                  <a href='cart.html'>Spirit Level</a>
                                  <br />
                                  <span className='quantity'>1 × $30.00</span>
                                </div>
                                <div className='product-image'>
                                  <a href='cart.html'>
                                    <img src={s2} alt='Product Image' />
                                  </a>
                                </div>
                              </li>
                            </ul>
                            ...
                            <div className='cart-btn text-center'>
                              <a className='crt-btn btn1' href='cart.html'>
                                View Cart
                              </a>
                              <a className='crt-btn btn2' href='checkout.html'>
                                Check Out
                              </a>
                            </div>
                          </div>
